...
export default function Footer() {
  return (
    <footer className="bg-theme-dark py-16 px-5 border-t border-theme-border text-theme-secondary">
      <div className="container-custom max-w-[1100px] mx-auto flex flex-col md:flex-row md:justify-between items-start space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <span className="font-sans text-[13px] leading-relaxed text-theme-secondary">
        ...
        <div className="flex flex-col space-y-6 max-w-[500px]">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            <Link to="/privacy-policy" className="font-sans text-[12px] text-theme-secondary hover:text-white transition-colors">
              Privacy Policy
            </Link>
            <Link to="/affiliate-disclaimer" className="font-sans text-[12px] text-theme-secondary hover:text-white transition-colors">
              Affiliate Disclaimer
            </Link>
            <Link to="/contact" className="font-sans text-[12px] text-theme-secondary hover:text-white transition-colors">
              Contact
            </Link>
          </div>

          {/* Detailed Affiliate Disclaimer */}
          <p className="font-sans text-[11px] leading-relaxed text-theme-secondary">
          ...
          <p className="font-sans text-[10px] text-theme-secondary mt-2">
