...
export default function Home() {
  return (
    <div className="w-full">
      ...
      <section className="section-pad bg-theme-alt border-t-0.5 border-b-0.5 border-theme-border">
        <div className="container-custom text-center space-y-12">
          <div className="space-y-3">
            ...
            <h2 className="text-[32px] md:text-[36px] text-theme-primary font-serif">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-theme-bg border-0.5 border-theme-border rounded-card p-6 flex flex-col items-center text-center space-y-4">
              <div className="w-12 h-12 rounded-full bg-theme-sage-light flex items-center justify-center text-theme-sage">
              ...
              <h3 className="font-serif text-[18px] text-theme-primary">Practical guides</h3>
            ...
            <div className="bg-theme-bg border-0.5 border-theme-border rounded-card p-6 flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="font-serif text-[18px] text-theme-primary">Honest recommendations</h3>
              <p className="font-sans text-[13px] text-theme-secondary leading-[1.6]">
            ...
            <div className="bg-theme-bg border-0.5 border-theme-border rounded-card p-6 flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="font-serif text-[18px] text-theme-primary">Meal planning help</h3>
              <p className="font-sans text-[13px] text-theme-secondary leading-[1.6]">
      ...
      <section className="section-pad bg-theme-bg">
        <div className="container-custom space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-[32px] md:text-[36px] text-theme-primary font-serif">Start reading</h2>
            <p className="font-sans text-[14px] text-theme-secondary max-w-[500px] mx-auto leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-theme-surface border-0.5 border-theme-border rounded-card overflow-hidden flex flex-col justify-between">
              <div>
                <div className="h-[90px] bg-theme-sage-light flex flex-col items-center justify-center border-b-0.5 border-theme-border">
                  <span className="font-serif text-[14px] text-theme-primary italic">Kitchen Tools</span>
                </div>
                <div className="p-5 flex flex-col items-start space-y-2 text-left">
                  <span className="eyebrow text-[10px]">Meal Prep</span>
                  <h4 className="font-sans font-bold text-[15px] text-theme-primary leading-snug">
                    The meal prep tools I actually use every single week
                  </h4>
                </div>
              </div>
              <div className="px-5 pb-5 pt-1 text-left">
                <Link to="/blog" className="font-sans text-[13px] text-theme-sage hover:text-theme-sage-dark transition-colors font-medium inline-flex items-center">
                  Read article &rarr;
                </Link>
              </div>
            </div>
            ...
            <div className="bg-theme-surface border-0.5 border-theme-border rounded-card overflow-hidden flex flex-col justify-between">
              <div>
                <div className="h-[90px] bg-theme-sage-light flex flex-col items-center justify-center border-b-0.5 border-theme-border">
                  <span className="font-serif text-[14px] text-theme-primary italic">Staples & Pills</span>
                </div>
                <div className="p-5 flex flex-col items-start space-y-2 text-left">
            ...
            <div className="bg-theme-surface border-0.5 border-theme-border rounded-card overflow-hidden flex flex-col justify-between">
              <div>
                <div className="h-[90px] bg-theme-sage-light flex flex-col items-center justify-center border-b-0.5 border-theme-border">
                  <span className="font-serif text-[14px] text-theme-primary italic">Budget Friendly</span>
                </div>
                <div className="p-5 flex flex-col items-start space-y-2 text-left">
      ...
      <section className="py-12 bg-theme-bg border-t border-theme-border">
        <div className="container-custom max-w-[800px] mx-auto grid grid-cols-3 gap-4 text-center">
          <div className="flex flex-col items-center justify-center space-y-1">
            <span className="font-mono text-[28px] text-theme-sage font-medium leading-none">600K+</span>
            <span className="font-sans text-[12px] text-theme-secondary">Monthly Pinterest views</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-1">
            <span className="font-mono text-[28px] text-theme-sage font-medium leading-none">Simple</span>
            <span className="font-sans text-[12px] text-theme-secondary">No-diet approach</span>
          </div>
          <div className="flex flex-col items-center justify-center space-y-1">
            <span className="font-mono text-[28px] text-theme-sage font-medium leading-none">100%</span>
            <span className="font-sans text-[12px] text-theme-secondary">Free to get started</span>
          </div>
        </div>
      </section>
    </div>
