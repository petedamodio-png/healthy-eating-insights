      ...
      <main className="min-h-screen bg-off-white">
        ...
        <section className="section-pad bg-off-white">
          <div className="container-custom max-w-[780px] mx-auto">
            ...
            <h1 className="text-[46px] leading-[1.2] text-near-black font-serif mt-4 mb-4">
              How to Actually Start Eating Healthy — A Realistic Guide
            </h1>
            <p className="font-sans text-[15px] text-text-gray leading-[1.7] mb-2">
              No meal plans. No rules. No giving up everything you enjoy. Just a clear starting point that works.
            </p>
            <p className="font-sans text-[13px] text-text-gray font-light">
              8 min read
            </p>
          ...
          <div className="container-custom max-w-[1100px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-[680px_260px] gap-12 lg:gap-8">
              ...
              <div className="space-y-8">
                {/* Intro */}
                <div className="font-sans text-[18px] text-text-gray leading-[1.7] space-y-4">
                  <p>
                ...
                <div className="space-y-4">
                  <h2 className="font-sans font-bold text-[26px] text-near-black">
                ...
                {/* Pull Quote */}
                <div className="bg-light-gray border-l-[3px] border-sage rounded-r-card pl-5 py-4">
                  <p className="font-serif italic text-[22px] text-near-black leading-[1.4]">
                ...
                <div className="space-y-3">
                  <h3 className="font-sans font-medium text-[20px] text-near-black">
                ...
                {/* Email Opt-in Box */}
                <div className="bg-sage-light rounded-card p-5">
                  <span className="eyebrow text-[10px]">FREE DOWNLOAD</span>
                  <h3 className="font-sans font-bold text-[18px] text-near-black mt-2 mb-2">
                    Get the Clean Eating Starter Guide — free
                  </h3>
                  <p className="font-sans text-[14px] text-text-gray mb-4">
                  ...
                  <form className="flex gap-2">
                    <input
                      ...
                      className="flex-1 font-sans text-[14px] border-0.5 border-border-gray rounded-card px-4 py-2"
                    />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {furtherReading.map((article, idx) => (
                      ...
                      >
                        <h4 className="font-sans font-medium text-[14px] text-near-black mb-2">
                          {article.title}
                        </h4>
              ...
              <div className="hidden lg:block sticky top-24 self-start space-y-4 max-h-screen overflow-y-auto">
                {/* Email Opt-in Box */}
                <div className="bg-sage-light rounded-card p-5">
                  <h3 className="font-sans font-bold text-[16px] text-near-black mb-2">
                    Get the free starter guide
                  </h3>
                  <p className="font-sans text-[13px] text-text-gray mb-4">
                  ...
                  <form className="space-y-2">
                    <input
                      type="email"
                      placeholder="your@email.com"
                      className="w-full font-sans text-[14px] border-0.5 border-border-gray rounded-card px-4 py-2"
                    />
                ...
                {/* You Might Also Like */}
                <div className="bg-white border-0.5 border-border-gray rounded-card p-5">
                  <h3 className="font-sans font-medium text-[14px] text-near-black mb-4">
                    You might also like
                  </h3>
                  <div className="space-y-3">
                    {sidebarLinks.map((link, idx) => (
                      <a
                        key={idx}
                        href="#"
                        className="font-sans text-[14px] text-sage hover:text-sage-dark block"
                      >
                        → {link}
                      </a>
                    ))}
