  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">Contact email: <a href="mailto:pete@healthyeatinginsights.com" className="text-theme-sage hover:text-theme-sage-dark">pete@healthyeatinginsights.com</a></p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="space-y-2 mb-4">
            <li>Amazon: <a href="https://amazon.com/privacy" className="text-theme-sage hover:text-theme-sage-dark" target="_blank" rel="noopener noreferrer">amazon.com/privacy</a></li>
            <li>iHerb: <a href="https://iherb.com/info/privacy-policy" className="text-theme-sage hover:text-theme-sage-dark" target="_blank" rel="noopener noreferrer">iherb.com/info/privacy-policy</a></li>
            <li>Thrive Market: <a href="https://thrivemarket.com/page/privacy-policy" className="text-theme-sage hover:text-theme-sage-dark" target="_blank" rel="noopener noreferrer">thrivemarket.com/page/privacy-policy</a></li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-4">To exercise any of these rights, contact us at <a href="mailto:pete@healthyeatinginsights.com" className="text-theme-sage hover:text-theme-sage-dark">pete@healthyeatinginsights.com</a>. We will respond within 30 days.</p>
          <p>If you are not satisfied with our response, you have the right to lodge a complaint with the Italian Data Protection Authority: <a href="https://garanteprivacy.it" className="text-theme-sage hover:text-theme-sage-dark" target="_blank" rel="noopener noreferrer">garanteprivacy.it</a></p>
        </>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mb-2">Email: <a href="mailto:pete@healthyeatinginsights.com" className="text-theme-sage hover:text-theme-sage-dark">pete@healthyeatinginsights.com</a></p>
