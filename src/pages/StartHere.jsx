      ...
      <section className="section-pad bg-theme-alt border-t-0.5 border-b-0.5 border-theme-border">
        <div className="container-custom max-w-[900px] space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-[32px] md:text-[36px] text-theme-primary font-serif">Sound familiar?</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {quotes.map((quote, idx) => (
              <div
                key={idx}
                className="bg-theme-surface border-l-[3px] border-theme-sage rounded-[14px] p-6 text-left border-t-0.5 border-r-0.5 border-b-0.5 border-theme-border/40"
              >
                <p className="font-sans text-[15px] italic text-theme-primary font-light leading-relaxed">
                  &ldquo;{quote}&rdquo;
                </p>
              </div>
            ))}
          ...
          <div className="text-center pt-4">
            <p className="font-sans text-[14px] text-theme-sage-dark font-medium">
      ...
      <section className="section-pad bg-theme-bg">
        <div className="container-custom max-w-[800px] space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-[32px] md:text-[36px] text-theme-primary font-serif">Here's what to do first.</h2>
          </div>
          ...
          <div className="flex flex-col space-y-6">
            {steps.map((step) => (
              <div
                key={step.num}
                className="bg-theme-surface border-0.5 border-theme-border rounded-card p-6 flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-5 text-left"
              >
                ...
                <div className="flex-col space-y-2">
                  <h3 className="font-serif text-[18px] text-theme-primary leading-tight">
                    {step.title}
                  </h3>
